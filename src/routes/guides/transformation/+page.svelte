...
<div class="guides-container">
    ...
    <Diagramatics title="Diagram.translate" subtitle="(v : Vector2)" {width} {height}>
        {`
        let sq = square(10);
    ...
    <Diagramatics title="Diagram.position" subtitle="(v : Vector2)" {width} {height}>
        {`
        let sq = square(10);
        let sq0 = sq.stroke('grey').strokedasharray([5]);
    ...
    <Diagramatics title="Diagram.rotate" subtitle="(angle : number, pivot? : Vector2)" {width} {height}>
        {`
        let sq = square(10);
        let sq0 = sq.stroke('grey').strokedasharray([5]);
    ...
    <Diagramatics title="Diagram.scale" subtitle="(scale : Vector2, origin? : Vector2)" {width} {height}>
        {`
        let sq = square(10);
        let sq0 = sq.stroke('grey').strokedasharray([5]);
    ...
    <Diagramatics title="Diagram.vflip" subtitle="(a? : number)" {width} {height}>
        {`
    ...
    <Diagramatics title="Diagram.hflip" subtitle="(a? : number)" {width} {height}>
        {`
    ...
    <Diagramatics title="Diagram.reflect" subtitle="(p1? : Vector2, p2? : Vector2)" {width} {height}>
        {`
        // if given 0 arguments, reflect over the origin
        // if given 1 argument, reflect over a point p1
        // if given 2 arguments, reflect over a line defined by two points p1 and p2
    ...
    <Diagramatics title="Diagram.reflect_over_point" subtitle="(p : Vector2)" {width} {height}>
        {`
    ...
    <Diagramatics title="Diagram.reflect_over_line" subtitle="(p1 : Vector2, p2 : Vector2)" {width} {height}>
        {`
        let penta   = regular_polygon(5, 10);
        let penta_0 = penta.stroke('grey').strokedasharray([5]);
    ...
    <Diagramatics title="Diagram.transform" subtitle="(transform_function : (p : Vector2) => Vector2)" {width} {height}>
        {`
        let sq = square(15);
